    ...
    public void render(final int mouseX, final int mouseY) {
        ...
        if (!this.custom) {
            if (mouseX > this.x - 7 && mouseX < this.x + 85 && mouseY > this.y - 6
                    && mouseY < this.y + FontManager.F18.getStringHeight(this.value.getName()) + 5) {
...
//					new Color(220, 220, 220).getRGB());
            ...
            mfont.drawString(this.value.getName(), this.x - 5, this.y + 1, new Color(184, 184, 184).getRGB());// 功能
