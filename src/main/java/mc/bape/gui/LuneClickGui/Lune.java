...
import mc.bape.utils.render.TranslateUtil;
...
import static mc.bape.utils.RenderUtils.drawCircle;
...
public class Lune extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        FontManager.F18.drawStringWithShadow(Client.CLIENT_NAME + Client.CLIENT_VERSION+" By " + Client.Team +" , credits: Medit_4 SuperSkidder LoRyu cubk", 5, 2, new Color(255, 255, 255).hashCode());
        FontManager.F18.drawStringWithShadow("Bape is a free client, if you pay any money for it means you got deceived.", 5, 14, new Color(255, 255, 255).hashCode());
        ...
        FontManager.F30.drawString(Client.CLIENT_SHORT_NAME, windowX + 15, windowY + 6, new Color(255, 255, 255).getRGB());
